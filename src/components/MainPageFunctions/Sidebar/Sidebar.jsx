  ...
  return (
    <div className='sidebar'>
        <div className="btn-wrapper">
            ...
            <div className={isSelectedIcon === 'home' ? 'selected' : 'item'} 
                onClick={() => {
                    handleButtonClick('home')
                    navigate('/')
                }}>
                {isSelectedIcon === 'home' ? <HomeIconSelected className='icons' /> : <HomeIcon className='icons' />}
                <div className="text">首頁</div>
            </div>
            <div className={isSelectedIcon === 'profile' ? 'selected' : 'item'} 
                onClick={() => {
                    handleButtonClick('profile')
                    navigate('/profile')
                }}>
                {isSelectedIcon ==='profile' ? <ProfileIconSelected className="icons" /> : <ProfileIcon className='icons' />}
                <div className="text">個人資料</div>
            </div>
            <div className={isSelectedIcon === 'setting' ? 'selected' : 'item'} 
                onClick={() => {
                    handleButtonClick('setting')
                    navigate('/setting')
                }}>
                {isSelectedIcon === 'setting' ? <SettingIconSelected className='icons' /> : <SettingIcon className='icons' />}
